...
const LandingPage = () => {
  ...
  const fullPantun = "Jalan-jalan ke Pasar Rebo, pulangnya naik JakLingko. Kalo bingung rute sama halte, mari buka WebGIS kite!";
  ...
  return (
    <>
      {/* MODAL AUTENTIKASI (Pindah ke luar motion.div agar fixed position tidak rusak oleh CSS filter) */}
      {showAdminModal && (
        <div className="fixed inset-0 z-[99999] bg-slate-950/80 flex items-center justify-center backdrop-blur-md">
      ...
      {/* Footer */}
      <footer className="bg-slate-950 border-t border-slate-900/50 pt-10 pb-4 relative overflow-hidden z-20">
        {/* Decorative background glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-32 bg-emerald-500/5 blur-[120px] rounded-[100%] pointer-events-none" />
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-6">
            
            {/* Kolom Kiri: Branding (Lebih dominan) */}
            <div className="col-span-1 md:col-span-5 flex flex-col items-start text-left pr-0 lg:pr-12">
              <div className="flex items-center gap-4 mb-3">
                <div className="p-2.5 bg-slate-900/80 border border-slate-800 rounded-2xl shadow-lg shadow-emerald-500/10">
                  <MapIcon className="w-5 h-5 text-emerald-400" />
                </div>
                <span className="font-bold text-xl tracking-tight text-white">
                  TransJakarta <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-600">Timur</span>
                </span>
              </div>
              <p className="text-slate-400 text-sm leading-relaxed mb-4">
                Platform visualisasi spasial interaktif untuk memetakan rute, halte, dan konektivitas angkutan umum secara akurat di seluruh wilayah Jakarta Timur.
              </p>
            </div>
            ...
            {/* Kolom Tengah: Eksplorasi (Menu) */}
            <div className="col-span-1 md:col-span-4 lg:col-span-3 flex flex-col items-start text-left">
              <h4 className="text-white font-semibold mb-3 tracking-widest text-xs uppercase flex items-center gap-3">
                <span className="w-6 h-[2px] rounded-full bg-emerald-500/50"></span> Navigasi
              </h4>
              <ul className="space-y-3 text-sm text-slate-400">
                <li>
                  <a href="#fitur" className="group flex items-center gap-2 hover:text-emerald-400 transition-colors w-fit">
                    <span>Fitur Andalan</span>
                    <span className="opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 font-bold">→</span>
                  </a>
                </li>
                <li>
                  <a href="#cara-pakai" className="group flex items-center gap-2 hover:text-emerald-400 transition-colors w-fit">
                    <span>Panduan Penggunaan</span>
                    <span className="opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 font-bold">→</span>
                  </a>
                </li>
                <li>
                  <a href="#tentang" className="group flex items-center gap-2 hover:text-emerald-400 transition-colors w-fit">
            ...
            <div className="col-span-1 md:col-span-3 lg:col-span-3 flex flex-col items-start text-left">
              <h4 className="text-white font-semibold mb-3 tracking-widest text-xs uppercase flex items-center gap-3">
                <span className="w-6 h-[2px] rounded-full bg-amber-500/50"></span> Komunitas
              </h4>
              <div className="flex gap-4">
                {/* GitHub */}
                <a href="https://github.com/PradanaFigo/Tubes_sig" target="_blank" rel="noreferrer" className="group relative w-10 h-10 flex items-center justify-center rounded-xl bg-slate-900 border border-slate-800 text-slate-400 hover:text-white hover:bg-slate-800 transition-all shadow-sm hover:shadow-emerald-500/20 hover:-translate-y-1 overflow-hidden" title="Repository GitHub">
                  ...
                  <svg className="w-4 h-4 relative z-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clipRule="evenodd" /></svg>
                </a>
                {/* Instagram */}
                <a href="#" className="group relative w-10 h-10 flex items-center justify-center rounded-xl bg-slate-900 border border-slate-800 text-slate-400 hover:text-white hover:bg-slate-800 transition-all shadow-sm hover:shadow-pink-500/20 hover:-translate-y-1 overflow-hidden" title="Instagram">
          ...
          <div className="w-full h-[1px] bg-gradient-to-r from-slate-800/0 via-slate-700/50 to-slate-800/0 my-6" />

          {/* Copyright */}
          <div className="flex justify-start text-[11px] sm:text-xs text-slate-500 font-medium pb-2">
            <p>&copy; {new Date().getFullYear()} Sistem Informasi Geografis TransJakarta Timur.</p>
          </div>
        </div>
      </footer>
